...
test('test', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'បន្ថែមជួរថ្មី' }).click();
  await page.getByRole('button', { name: 'ជ្រើសរើសលក្ខណៈវិនិច្ឆ័យ', exact: true }).last().click();
  await page.locator('[id^="fi-select-input-option-"]:visible').filter({ hasText: /^CS51\b/ }).first().click();
  await page.getByRole('textbox', { name: 'Brainstorm text' }).nth(1).fill('វិន័យសិស្ស');
  ...
  await page.getByRole('button', { name: 'បន្ថែមជួរថ្មី' }).click();
  await page.getByRole('button', { name: 'ជ្រើសរើសលក្ខណៈវិនិច្ឆ័យ', exact: true }).last().click();
  await page.locator('[id^="fi-select-input-option-"]:visible').filter({ hasText: /^CS03\b/ }).first().click();
  await page.getByRole('textbox', { name: 'Brainstorm text' }).nth(4).fill('អគ្គិសនីប្រើប្រាស់');
  await page.getByRole('button', { name: 'បន្ទាប់' }).click();
  await page.getByRole('button', { name: 'បន្ទាប់' }).click();
  ...
  await page.locator('.premium-modal > div:nth-child(2) > div:nth-child(2) > div:nth-child(3)').click();
  ...
  await page.getByRole('listitem').filter({ hasText: /CS51/ }).first().getByPlaceholder('ចំណុចខ្លាំង').click();
  await page.getByRole('listitem').filter({ hasText: /CS51/ }).first().getByPlaceholder('ចំណុចខ្លាំង').fill('វិន័យសិស្ស');
  await page.getByRole('listitem').filter({ hasText: /CS51/ }).first().getByPlaceholder('ចំណុចខ្សោយ').click();
  await page.getByRole('listitem').filter({ hasText: /CS51/ }).first().getByPlaceholder('ចំណុចខ្សោយ').fill('វិន័យសិស្ស');
  await page.getByRole('listitem').filter({ hasText: /CS51/ }).first().getByPlaceholder('មតិយោបល់').click();
  await page.getByRole('listitem').filter({ hasText: /CS51/ }).first().getByPlaceholder('មតិយោបល់').fill('វិន័យសិស្ស');
  await page.getByText('ស្វែងរក ឬបញ្ចូល').nth(1).click();
  await page.getByRole('textbox', { name: 'ស្វែងរក ឬបញ្ចូលចម្លើយថ្មី' }).click();
  await page.getByRole('textbox', { name: 'ស្វែងរក ឬបញ្ចូលចម្លើយថ្មី' }).fill('វិន័យសិស្ស');
  await page.locator('li:nth-child(2) > .fi-fo-repeater-item-content > .fi-sc > .fi-grid-col.lg\\:fi-grid-col-span > .fi-sc-component > .form-row > .premium-modal > div:nth-child(2) > div:nth-child(2) > div').first().click();
  await page.getByRole('button', { name: 'រក្សាទុក' }).click();
  ...
  await page.locator('li:nth-child(4) > .fi-fo-repeater-item-content > .fi-sc > .fi-grid-col.lg\\:fi-grid-col-span > .fi-sc-component > .form-row > .premium-modal > div:nth-child(2) > div:nth-child(2) > div').first().click();
  await page.getByRole('button', { name: 'រក្សាទុក' }).click();
  ...
  await page.getByRole('listitem').filter({ hasText: /CS03/ }).first().getByPlaceholder('ចំណុចខ្លាំង').click();
  await page.getByRole('listitem').filter({ hasText: /CS03/ }).first().getByPlaceholder('ចំណុចខ្លាំង').fill('អគ្គិសនីប្រើប្រាស់');
  await page.getByRole('listitem').filter({ hasText: /CS03/ }).first().getByPlaceholder('ចំណុចខ្សោយ').click();
  await page.getByRole('listitem').filter({ hasText: /CS03/ }).first().getByPlaceholder('ចំណុចខ្សោយ').fill('អគ្គិសនីប្រើប្រាស់');
  await page.getByRole('listitem').filter({ hasText: /CS03/ }).first().getByPlaceholder('មតិយោបល់').click();
  await page.getByRole('listitem').filter({ hasText: /CS03/ }).first().getByPlaceholder('មតិយោបល់').fill('អគ្គិសនីប្រើប្រាស់');
  await page.getByText('ស្វែងរក ឬបញ្ចូល').nth(4).click();
  await page.getByRole('textbox', { name: 'ស្វែងរក ឬបញ្ចូលចម្លើយថ្មី' }).click();
  await page.getByRole('textbox', { name: 'ស្វែងរក ឬបញ្ចូលចម្លើយថ្មី' }).fill('អ');
  await page.getByRole('dialog').getByText('CS03 - អគ្គិសនីប្រើប្រាស់').click();
  await page.getByRole('button', { name: 'រក្សាទុក' }).click();
